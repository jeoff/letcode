...
public class ListUtils {
    ...
    public static <T> List<List<T>> splitList2(List<T> list, int count) { //效率低不推荐使用
        ...
        long t2 = System.currentTimeMillis();
        System.out.println("splitList2====>>> resList.size:" + list.size()
                + ", count:" +count + ", costs time:" + (t2 - t1) + " ms");
        return result;
    }
    ...
    public static void main(String[] args) {
        ...
        List<List<Integer>> splitList2 = splitList2(list, 5);
        System.out.println("splitList2: " + splitList2);
